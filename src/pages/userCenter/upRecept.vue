...
export default {
    ...
    methods: {
        ...
        send() {
            ...
            //     return;
            //   }
            var _content = "{'order_code':'" + this.$route.query.orderCode + "','group_code':'" + this.$route.query.groupCode + "'}";
             this.$post("/appOrder3/upReceiptByGroupCode.do", {
                content: _content,
                version: "kkllo",
